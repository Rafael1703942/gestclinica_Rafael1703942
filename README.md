...
A figura 1.1 ,1.2 e 1.3 apresenta o modelo entidade relacionamento do sistema de gestão de uma clinica , cada trabalhador produz a respetiva fatura do cliente e os trabalhadores registão
os clientes em sistema.

![Alt text](imagens/Modeloerresquema.jpg "modeloer")

Figura 1.1: Modelo ER da base de dados operacional relacionamento do funcionamento das
tabelas onde temos as tabelas Admin e Trabalhadores.

![Alt text](imagens/Modeloerresquema2.jpg "modeloer")

Figura 1.2: Modelo ER da base de dados operacional relacionamento do funcionamento das
tabelas onde temos as tabelas Clientes e Faturas.

![Alt text](imagens/Modeloerresquema3.jpg "modeloer")

Figura 1.3: Modelo ER da base de dados operacional relacionamento do funcionamento das
...
As dimensões para a Gestão do Sistema de uma Clinica:
Admin: entidade responsável por armazenar e modificar as informações dos funcionários registados;
...
Figura 3.1: Modelo ER da base de dados operacional relacionamento do funcionamento das
tabelas onde temos as tabelas Trabalhadores e Faturas.
...
Figura 4.1: Modelo ER da base de dados operacional relacionamento do funcionamento das
tabelas onde temos as tabelas Trabalhadores e Faturas. 
...
![Alt text](imagens/Figura2.4.jpg "modeloer")
...
Figura 5.1: Tabela de Administradores.

![Alt text](imagens/criar2trabalhador.jpg "modeloer")

Figura 5.2: Tabela de Trabalhadores.

![Alt text](imagens/criar3cliente.jpg "modeloer")

Figura 5.3: Tabela de Clientes.

![Alt text](imagens/faturas.jpg "modeloer")

Figura 5.4: Tabela de Faturas.
